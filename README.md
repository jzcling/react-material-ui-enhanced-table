...
| date                        | `string` | undefined                                | Filter dates. Must be in the form yyyy-MM-dd                                                                                                                                                               |
| dates                       | `object` | undefined                                | Filter dates. Must be in the form `{ from: "yyyy-MM-dd", to: "yyyy-MM-dd" }`                                                                                                                               |
